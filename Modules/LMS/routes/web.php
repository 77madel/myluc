...
Route::group(['middleware' => ['checkInstaller']], function () {
    ...
    Route::get('forums', [ForumController::class, 'forumsList'])->name('forumsList');
    Route::get('forums/{slug}', [ForumController::class, 'forumDetail'])->name('forum.detail');
    Route::get('forums/topic/{slug}', [ForumController::class, 'topicDetail'])->name('forum.topic.detail');
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::post('forums/reply', [ForumController::class, 'storeReply'])->name('forum.reply.store');
        Route::get('forums/{forum_slug}/create-topic', [ForumController::class, 'createTopic'])->name('forum.topic.create');
        Route::post('forums/{forum_slug}/store-topic', [ForumController::class, 'storeTopic'])->name('forum.topic.store');
