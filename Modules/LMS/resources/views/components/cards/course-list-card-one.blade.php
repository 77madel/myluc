                ...
                @else
                    <div
                        ...
                        @if (isset($course?->coursePrice) &&
                            ...
                            <span>{{ dotZeroRemove($course?->coursePrice?->discounted_price ?? 0) }}{{ $currencySymbol }}</span>
                            <span>
                                <del
                                    class="text-heading/50 text-[16px] font-semibold">{{ dotZeroRemove($course?->coursePrice?->price ?? 0) }}{{ $currencySymbol }}</del>
                            </span>
                        @else
                            <span>{{ dotZeroRemove($course?->coursePrice?->price ?? 0) }}{{ $currencySymbol }}</span>
                        @endif
                    </div>
                @endif
            </div>
